...
C-----------------------------------------------------------------------
C
C     1 and 2 and 3-D boundary value arrays:
C
      real
     $  ele            ,eln            ,els            ,elw            ,
     $  sbe            ,sbn            ,sbs            ,sbw            ,
...
C
     ...
     $  uamp(im,jm,ntide),vamp(im,jm,ntide),eamp(im,jm,ntide),
     $  upha(im,jm,ntide),vpha (im,jm,ntide),epha(im,jm,ntide),
     $  freq0(ntide),
     $  utid(im,jm)       ,vtid(im,jm)      ,etid(im,jm)
C
C-----------------------------------------------------------------------
C
