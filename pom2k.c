...
C
     ...
     $  q2lb(im,jm,kb) ,q2l(im,jm,kb)  ,
     $  rhob(im,jm,kb) ,rho(im,jm,kb)  ,rmean(im,jm,kb),
     $  sb(im,jm,kb)   ,sclim(im,jm,kb),s(im,jm,kb)    ,
     $  tb(im,jm,kb)   ,tclim(im,jm,kb),t(im,jm,kb)    ,
     $  ub(im,jm,kb)   ,uf(im,jm,kb)   ,u(im,jm,kb)    ,
     $  vb(im,jm,kb)   ,vf(im,jm,kb)   ,v(im,jm,kb)    ,
...
C
      common/a0/
     $  Tref(im,jm,kb),Sref(im,jm,kb),Rref(im,jm,kb)
c
